...
\fig{imgs/stats_rna}{0.5}{}{fig:stats_rna}
...
\todo{Does this part really need to be mentioned?}
...
\todo{Cite regression: https://connect.microsoft.com/VisualStudio/feedback/details/640588)}

Recently, a threaded task scheduler was added to Blender named BLI\_task. \todo{cite: http://lists.blender.org/pipermail/bf-blender-cvs/2013-October/059841.html}
...
\fig{imgs/stats_mt}{0.5}{}{fig:stats_mt}
...
\fig{imgs/stats_hws}{0.5}{}{fig:stats_hws}
