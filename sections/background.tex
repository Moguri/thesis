...
where $T_v$ is the four-by-four transform matrix of the vertex, $b$ is a bone, $I_b$ is the scalar influence (i.e., the weights) of $b$ on the vertex and $T_b$ is the four-by-four transform matrix of the bone.
